...
6. STEP NO LONGER NECESSARY : INTEGRATED INTO SCRIPT "master_deploy.js", but kept for reference.

	Initiate the mongo replica set with ozwillo-mongo-1 as primary :
	...
	```
7. Open the Virtualbox GUI and setup redirection of port 8080 : right-click on the VM > Configuration > Network > Advanced > Port Redirection > Click the Add button (right of the window) > and fill in the info (Name : whatever you want, Protocol : TCP, Host IP : 127.0.0.1, Host Port : 8080, Guest IP : let it empty, Guest Port : 8080) > OK > OK > Close Virtualbox window.
